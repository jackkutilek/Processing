...
public class ArcBall {
  ...
  public ArcBall(PApplet parent, GUI pGUI) {

    this(parent.g.width/2.0f - parent.g.width/5.0,parent.g.height/3.0f*2,-PApplet.min(parent.g.width/2.0f,parent.g.height/2.0f),PApplet.min(parent.g.width/2.0f,parent.g.height/2.0f), parent,pGUI);
  }



  public ArcBall(float center_x, float center_y, float center_z, float radius, PApplet parent, GUI pGUI) {
